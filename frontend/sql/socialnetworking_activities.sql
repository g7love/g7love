...
CREATE TABLE `activities` (
  ...
  `tablename` char(54) NOT NULL COMMENT '表名',
  `activitiesname` char(54) NOT NULL COMMENT '活动名称',
  `column` char(100) NOT NULL COMMENT '列名称',
  ...
  PRIMARY KEY (`userid`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='活动表';
